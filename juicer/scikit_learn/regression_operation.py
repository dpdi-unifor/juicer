...
class RegressionOperation(Operation):
        ...
        def __init__(self, parameters, named_inputs, named_outputs):
            ...
            self.output = named_outputs.get(
                    'algorithm', 'regressor_algorithm_{}'.format(self.order))
...
class GradientBoostingRegressorModelOperation(RegressionOperation):
    LEARNING_RATE_PARAM = 'learning_rate'
    N_ESTIMATORS_PARAM = 'n_estimators'
    MAX_DEPTH_PARAM = 'max_depth'
    MIN_SPLIT_PARAM = 'min_samples_split'
    ...
    def __init__(self, parameters, named_inputs, named_outputs):
        ...
        self.name = 'regression.GradientBoostingRegressorModelOperation'
        if self.has_code:
    ...
    def generate_code(self):
        ...
        n_estimators={n_estimators}, max_depth={max_depth}, 
        min_samples_split={min_samples_split}, 
        min_samples_leaf={min_samples_leaf}, random_state={seed}).fit(X, y)
...
class HuberRegressorModelOperation(RegressionOperation):
...
class IsotonicRegressionModelOperation(RegressionOperation):
    ...
    def generate_code(self):
        ...
        {model} = IsotonicRegression(increasing={isotonic}).fit(X, y)
...
class LinearRegressionModelOperation(RegressionOperation):
    ...
    def generate_code(self):
        ...
        {model} = ElasticNet(alpha={alpha}, l1_ratio={elastic}, 
                tol={tol}, max_iter={max_iter}, random_state={seed}, 
...
class MLPRegressorModelOperation(RegressionOperation):
    ...
    def __init__(self, parameters,  named_inputs, named_outputs):
        RegressionOperation.__init__(self, parameters,
...
class RandomForestRegressorModelOperation(RegressionOperation):
    ...
    def __init__(self, parameters, named_inputs, named_outputs):
        RegressionOperation.__init__(self, parameters, named_inputs,
                                     named_outputs)
        self.parameters = parameters
        self.name = 'regression.RandomForestRegressormModelOperation'
        self.has_code = any([len(named_outputs) > 0, self.contains_results()])
...
class SGDRegressorModelOperation(RegressionOperation):
    ...
    def generate_code(self):
        ...
        {model} = SGDRegressor(alpha={alpha},
                l1_ratio={l1_ratio}, max_iter={max_iter},
                tol={tol}, random_state={seed}).fit(X, y)
